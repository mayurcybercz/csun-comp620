...
#define mpc MPI_COMM_WORLD
    ...
    int main(int argc, char **argv){
      ...
      //because of this startpoint and endpoint....even though each process receive complete array
      //only 10 elements are invloved in addition...i.e in b/w startpt and endpt
      k = n / procs;
      startpt  = id    * k;
      endpt   = startpt  + k;
